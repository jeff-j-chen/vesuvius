...
class DataConfig:
    ...
    selective_chunk_preload: bool = False
...
class ModelConfig:
    ...
    norm_mode: str = "auto"  # auto follows use_ibn; explicit: instance, ibn, ibn_full, batch
