...
RUN_SPECS: List[RunSpec] = [
    ...
    RunSpec(
        run_id=11,
        name="t11_hm_frac_002",
        axis="hard_mining",
        overrides={"hm-frac": 0.02},
        why="aggressively reduce hard-mined sample pressure",
        expect="less over-brightening and less mining-induced drift",
    ),
    RunSpec(
        run_id=12,
        name="t12_hn_cut_090",
        axis="hard_mining",
        overrides={"hm-frac": 0.02, "hn-cutoff": 0.9},
    ...
    RunSpec(
        ...
        name="t13_hn_cut_070",
        axis="hard_mining",
        overrides={"hm-frac": 0.02, "hn-cutoff": 0.7},
    ...
    RunSpec(
        ...
        name="t14_hp_cut_035",
        axis="hard_mining",
        overrides={"hm-frac": 0.02, "hp-cutoff": 0.35},
    ...
    RunSpec(
        ...
        name="t15_hp_cut_055",
        axis="hard_mining",
        overrides={"hm-frac": 0.02, "hp-cutoff": 0.55},
