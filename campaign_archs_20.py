...
def base_config(exp_name: str) -> Config:
    ...
    config.dl.cutout_prob = 0.5
    config.dl.cutout_max_frac = 0.12
    config.dl.cutout_n_patches = 2
    ...
    config.dl.context_replace_prob = 0.25
    config.dl.context_replace_keep_size = 0
    config.dl.context_replace_margin = 24
    config.dl.context_replace_feather = 24
