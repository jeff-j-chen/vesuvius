...
PRETRAIN_SPECS = {
    ...
    "mednext_k5": ("--mednext-adapters", "--mednext-kernel", "5"),
    "mednext_k7": ("--mednext-adapters", "--mednext-kernel", "7"),
    "mednext_k7_divided": (
        "--mednext-adapters", "--mednext-kernel", "7",
...
TRAIN_SCROLL_WEIGHTS = [2, 1, 1, 1, 1, 1, 1]
_SCROLL_IDS = tuple(
    scroll_id
